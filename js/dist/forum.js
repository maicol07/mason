...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_Composer__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'hide', function (e) {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionComposer__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'headerItems', function (items) {
    ...
    this.fieldsByTags = []; // so this list contains whether a tag has fields!
    ...
    if (byTagEnabled) {
      ...
      this.fieldsByTags = _components_FieldsEditorByTags__WEBPACK_IMPORTED_MODULE_5__["default"].component({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_utils_DiscussionControls__WEBPACK_IMPORTED_MODULE_1___default.a, 'moderationControls', function (items, discussion) {
    if (discussion.canUpdateRaafiRiveroMasonAnswers()) {
      items.add('raafirivero-mason-update-answers', flarum_components_Button__WEBPACK_IMPORTED_MODULE_2___default.a.component({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'items', function (items) {
    if (!this.props.discussion.canSeeRaafiRiveroMasonAnswers() || !flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.fields-in-hero')) {
      return;
    }

    items.add('raafirivero-mason-fields', _components_FieldsViewer__WEBPACK_IMPORTED_MODULE_4__["default"].component({
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["override"])(flarum_components_Composer__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'animateToPosition', function (original, position) {
    ...
    m.redraw(true);
    $composer.show();
    var newComposerHeight = ''; // const headerHeight = this.$('.ComposerBody-header').outerHeight();
    ...
    if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.composer-height')) {
      newComposerHeight = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.composer-height');
    } else {
...
function showFieldsOnPost(post) {
  ...
  return post.number() === 1 && !flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.fields-in-hero');
}
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'init', function () {
    ...
    this.subtree.check(function () {
      ...
      return _this.props.post.discussion().raafiriveroMasonAnswers().map(function (answer) {
        return answer.id();
      }).join(',');
    });
  });
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    var relationshipInfo = {
      field: {
        data: flarum_Model__WEBPACK_IMPORTED_MODULE_2___default.a.getIdentifier(this.field)
      }
    };
      ...
      onchange: function onchange(event) {
        ...
        for (var _iterator = event.target.options, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
          ...
          if (option.selected && option.value !== 'none') {
            ...
            var storeObj = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.getById('raafirivero-mason-answer', answerId);
    ...
    }, this.selectPlaceholder()), Object(_lib_helpers_sortByAttribute__WEBPACK_IMPORTED_MODULE_5__["default"])(this.field.suggested_answers()).map(function (answer) {
      return m('option', {
        value: answer.id(),
  ...
  _proto.placeholderHidden = function placeholderHidden() {
    ...
    if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.labels-as-placeholders')) {
      return false;
    }
  ...
  _proto.selectPlaceholder = function selectPlaceholder() {
    ...
    if (this.field.required()) {
      text += flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.answers.choose-option');
    } else {
      text += flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.answers.no-option-selected');
    }
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    if (this.maxPrimary > 1 || this.maxSecondary > 1) {
      return m('.Alert', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.tags.inadequate-settings'));
  ...
  _proto.fieldLabel = function fieldLabel() {
    var text = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.tags-field-name') || flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.tags.tags-label');
    ...
    return m('input.FormControl', {
      ...
      oninput: m.withAttr('value', function (value) {
        ...
        if (_this2.content === '') {
          ...
          var answer = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.createRecord('raafirivero-mason-answer', {
            attributes: {
...
function (_Component) {
  ...
  _proto.view = function view() {
    var columnClass = "masoncol" + flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.column-count');
    return m('.Mason-Grid', {
      "class": columnClass
    }, this.props.items);
  };
...
function (_Component) {
  ...
  _proto.fieldItems = function fieldItems() {
    ...
    if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.tags-as-fields')) {
...
function (_Component) {
  ...
  _proto.fieldItems = function fieldItems() {
    ...
    this.fields.forEach(function (field) {
      ...
      if (field.user_values_allowed()) {
        input = new _FieldEditText__WEBPACK_IMPORTED_MODULE_7__["default"](inputAttrs);
      } else {
        input = new _FieldEditDropdown__WEBPACK_IMPORTED_MODULE_6__["default"](inputAttrs);
      }
...
function (_Modal) {
  ...
  _proto.init = function init() {
    ...
    this.tagRelationship = this.props.discussion.data.relationships.tags.data[0]; // Stays null if the feature is not used

    this.tags = null;
    var ByTagsUnit = new _ByTagsComposer__WEBPACK_IMPORTED_MODULE_6__["default"]();
    var matchingTags = ByTagsUnit.matchTags();
    this.myFields = []; // annoying way to get current Tag name, but it works

    var thisIncludes = this.props.discussion.payload.included;
  ...
  _proto.title = function title() {
    return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.answers-modal.edit-title', {
      title: m('em', this.props.discussion.title())
    });
  };

  _proto.content = function content() {
    return [m('.Modal-body', _FieldsEditorByTags__WEBPACK_IMPORTED_MODULE_5__["default"].component({
      discussion: this.props.discussion,
    ...
    m('.Modal-footer', [flarum_components_Button__WEBPACK_IMPORTED_MODULE_3___default.a.component({
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.answers-modal.save'),
...
function (_Component) {
  ...
  _proto.init = function init() {
    this.fields = Object(_lib_helpers_sortByAttribute__WEBPACK_IMPORTED_MODULE_7__["default"])(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.all('raafirivero-mason-field'));
  ...
  _proto.view = function view() {
    ...
    if (!fields.length && (!head.length || flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('raafirivero.mason.hide-empty-fields-section'))) {
      // We need to return an actual dom element or Flarum does not like it
      return m('div');
    }

    return m('.Mason-Discussion', [head, m('.Mason-divider', '–'), m('.Mason-Set', {
      "class": "masonjson"
    }, fields), m('.Mason-divider', '–')]);
  };
  ...
  _proto.headItems = function headItems() {
    ...
    if (this.discussion.canUpdateRaafiRiveroMasonAnswers()) {
      items.add('edit', flarum_components_Button__WEBPACK_IMPORTED_MODULE_5___default.a.component({
        ...
        children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.discussion-controls.edit-answers'),
        icon: 'fas fa-pen',
        onclick: function onclick() {
  ...
  _proto.fieldsItems = function fieldsItems() {
    ...
    this.fields.forEach(function (field) {
      ...
      var answers = Object(_lib_helpers_sortByAttribute__WEBPACK_IMPORTED_MODULE_7__["default"])(_this2.discussion.raafiriveroMasonAnswers().filter(function (answer) {
      ...
      if (answers.length === 0) {
        if (field.show_when_empty()) {
          answer_list.push(m('em.Mason-Inline-Answer', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.forum.post-answers.no-answer')));
        } else {
      ...
      items.add('field-' + field.id(), m('.Mason-item', [m('label', [field.icon() ? [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_2___default()(field.icon()), ' '] : null, field.name() + ": "]), m('.Mason-Answers', answer_list)]));
    });
    return items;
  };
...
/* harmony import */ var flarum_models_Forum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! flarum/models/Forum */ "flarum/models/Forum");
/* harmony import */ var flarum_models_Forum__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(flarum_models_Forum__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _lib_models_Field__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../lib/models/Field */ "./src/lib/models/Field.js");
/* harmony import */ var _lib_models_ByTag__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../lib/models/ByTag */ "./src/lib/models/ByTag.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('raafirivero-mason', function (app) {
  app.store.models['raafirivero-mason-field'] = _lib_models_Field__WEBPACK_IMPORTED_MODULE_5__["default"];
  app.store.models['raafirivero-mason-answer'] = _lib_models_Answer__WEBPACK_IMPORTED_MODULE_4__["default"];
  app.store.models['raafirivero-mason-bytag'] = _lib_models_ByTag__WEBPACK_IMPORTED_MODULE_6__["default"];
  flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.raafiriveroMasonAnswers = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.hasMany('raafiriveroMasonAnswers');
  flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.canSeeRaafiRiveroMasonAnswers = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('canSeeRaafiRiveroMasonAnswers');
  flarum_models_Discussion__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.canUpdateRaafiRiveroMasonAnswers = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('canUpdateRaafiRiveroMasonAnswers');
  flarum_models_Forum__WEBPACK_IMPORTED_MODULE_3___default.a.prototype.canFillRaafiRiveroMasonFields = flarum_Model__WEBPACK_IMPORTED_MODULE_1___default.a.attribute('canFillRaafiRiveroMasonFields');
  Object(_addComposerFields__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_addFieldsOnDiscussionHero__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_addFieldsOnDiscussionPost__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(_addFieldUpdateControl__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_patchModelIdentifier__WEBPACK_IMPORTED_MODULE_11__["default"])();
});
