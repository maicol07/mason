...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_3___default.a.prototype, 'permissionItems', function (groups) {
    ...
    items.add('see-own-fields', {
      icon: 'fas fa-eye',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.see-own-fields'),
      permission: 'raafirivero.mason.see-own-fields'
    });
    items.add('see-other-fields', {
      icon: 'fas fa-eye',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.see-other-fields'),
      permission: 'raafirivero.mason.see-other-fields',
      allowGuest: true
    });
    items.add('fill-fields', {
      icon: 'fas fa-tasks',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.fill-fields'),
      permission: 'raafirivero.mason.fill-fields'
    });
    items.add('update-own-fields', {
      icon: 'fas fa-edit',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.update-own-fields'),
      permission: 'raafirivero.mason.update-own-fields'
    });
    items.add('update-other-fields', {
      icon: 'fas fa-edit',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.update-other-fields'),
      permission: 'raafirivero.mason.update-other-fields',
      allowGuest: true
    });
    items.add('skip-required-fields', {
      icon: 'fas fa-forward',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.skip-required-fields'),
      permission: 'raafirivero.mason.skip-required-fields'
    });
    groups.add('raafirivero-mason', {
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.permissions.mason-heading'),
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    this.answer.is_suggested() ? [m('span.fa.fa-arrows-alt-v.Mason-Box--handle.js-answer-handle'), ' '] : null, m('span', {
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.is_suggested')
    }), m('.ButtonGroup', [flarum_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      type: 'submit',
      className: 'Button Button--primary',
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.save-answer'),
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.delete-answer'),
      loading: this.processing,
  ...
  _proto.deleteAnswer = function deleteAnswer() {
    ...
    if (!confirm(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.messages.delete-answer-confirmation', {
...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    if (!this.field.exists) {
      return m('div', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.save-field-for-answers'));
    }
    ...
    }, [m('.Mason-Box-Header-Title', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.show-user-answers', {
    ...
    this.showUserAnswers ? m('.Mason-Container', Object(_lib_helpers_sortByAttribute__WEBPACK_IMPORTED_MODULE_7__["default"])(userAnswers, 'content').map(function (answer) {
      ...
      placeholder: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.new-answer-placeholder')
    })]), m('.Form-group', [flarum_components_Button__WEBPACK_IMPORTED_MODULE_4___default.a.component({
      type: 'submit',
      className: 'Button Button--primary',
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.add-answer'),
      loading: this.processing,
...
function (_Component) {
  ...
  _proto.initNewField = function initNewField() {
    this.field = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.createRecord('raafirivero-mason-field', {
      attributes: {
        name: '',
        description: '',
        min_answers_count: 0,
  ...
  _proto.boxTitle = function boxTitle() {
    ...
    return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.new-field');
  };
  ...
  _proto.view = function view() {
    ...
    }, [m('.Mason-Box-Header-Title', this.boxTitle()), m('div', [this.field.exists ? [flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.edit-field'), ' '] : null, flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_2___default()('fas fa-chevron-' + (this.toggleFields ? 'up' : 'down'))])]), this.toggleFields ? this.viewFields() : null]);
  };

  _proto.viewFields = function viewFields() {
    var _this2 = this;

    return m('form', [m('.Mason-Box--row', [m('.Mason-Box--column', [m('h4', 'Field settings'), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.name')), m('input.FormControl', {
      value: this.field.name(),
      oninput: m.withAttr('value', this.updateAttribute.bind(this, 'name'))
    }), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.name-help'))]), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.description')), m('input.FormControl', {
      value: this.field.description(),
      oninput: m.withAttr('value', this.updateAttribute.bind(this, 'description'))
    }), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.description-help'))]), m('.Form-group', [m('label', [// TODO: while multiple answers are still in the work, show the "min answers" field as a checkbox
    flarum_components_Switch__WEBPACK_IMPORTED_MODULE_5___default.a.component({
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.required')
    })])]),
    /*m('.Form-group', [
        m('label', app.translator.trans('raafirivero-mason.admin.fields.min_answers_count')),
        m('input.FormControl', {
            type: 'number',
            min: 0,
    ...
    m('.Form-group', [
        m('label', app.translator.trans('raafirivero-mason.admin.fields.max_answers_count')),
        m('input.FormControl', {
            type: 'number',
            min: 1,
    ...
    m('.Form-group', [m('label', [flarum_components_Switch__WEBPACK_IMPORTED_MODULE_5___default.a.component({
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.show_when_empty')
    })]), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.show_when_empty-help'))]), m('.Form-group', [m('label', [flarum_components_Switch__WEBPACK_IMPORTED_MODULE_5___default.a.component({
      state: this.field.user_values_allowed(),
      onchange: this.updateAttribute.bind(this, 'user_values_allowed'),
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.user_values_allowed')
    })]), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.user_values_allowed-help'))]), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.validation')), m('input.FormControl', {
      disabled: !this.field.user_values_allowed(),
      placeholder: this.field.user_values_allowed() ? '' : flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.enable-user-values-for-validation'),
      value: this.field.validation(),
      oninput: m.withAttr('value', this.updateAttribute.bind(this, 'validation'))
    }), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.validation-help', {
      a: m('a[href=https://laravel.com/docs/5.1/validation#available-validation-rules][_target=blank]')
    }))]), m('.Form-group', [m('label', [flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.icon'), this.iconPreview(this.field.icon())]), m('input.FormControl', {
      value: this.field.icon(),
      oninput: m.withAttr('value', this.updateAttribute.bind(this, 'icon'))
    }), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.icon-help', {
      ...
      type: 'submit',
      className: 'Button Button--primary',
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.' + (this.field.exists ? 'save' : 'add') + '-field'),
      loading: this.processing,
      disabled: !this.readyToSave(),
      onclick: this.saveField.bind(this)
      ...
      type: 'submit',
      className: 'Button Button--danger',
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.buttons.delete-field'),
      loading: this.processing,
  ...
  _proto.deleteField = function deleteField() {
    ...
    if (!confirm(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.messages.delete-field-confirmation', {
  ...
  _proto.iconPreview = function iconPreview(value) {
    ...
    return [' (', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.fields.icon-preview', {
...
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _TagFields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TagFields */ "./src/admin/components/TagFields.js");
...
function (_Component) {
  ...
  _proto.init = function init() {
    this.fieldsSectionTitle = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.fields-section-title'] || '');
    this.columnCount = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.column-count'] || 1);
    this.byTag = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.by-tag'] > 0);
    this.labelsAsPlaceholders = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.labels-as-placeholders'] > 0);
    this.fieldsInHero = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.fields-in-hero'] > 0);
    this.hideEmptyFieldsSection = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.hide-empty-fields-section'] > 0);
    this.tagsAsFields = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.tags-as-fields'] > 0);
    this.tagsFieldName = m.prop(flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.data.settings['raafirivero.mason.tags-field-name'] || '');
    this.columnOptions = {};
  ...
  _proto.view = function view() {
    ...
    return m('.Mason-Container', [m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      state: this.byTag(),
      onchange: this.updateSetting.bind(this, this.byTag, 'raafirivero.mason.by-tag'),
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.by-tag')
    }))]), this.byTag() ? m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.by-tag-name')), tagsList]) : null, m('hr'), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.fields-section-title')), m('input.FormControl', {
      value: this.fieldsSectionTitle(),
      placeholder: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.fields-section-title-placeholder'),
      onchange: m.withAttr('value', this.updateSetting.bind(this, this.fieldsSectionTitle, 'raafirivero.mason.fields-section-title'))
    }), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.fields-section-title-help'))]), m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.column-count')), flarum_components_Select__WEBPACK_IMPORTED_MODULE_5___default.a.component({
    ...
    })), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.labels-as-placeholders-help'))]), m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      state: this.fieldsInHero(),
      onchange: this.updateSetting.bind(this, this.fieldsInHero, 'raafirivero.mason.fields-in-hero'),
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.fields-in-hero')
    }))]), m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      ...
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.hide-empty-fields-section')
    })), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.hide-empty-fields-section-help'))]), m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      state: this.tagsAsFields(),
      onchange: this.updateSetting.bind(this, this.tagsAsFields, 'raafirivero.mason.tags-as-fields'),
      children: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.tags-as-field')
    })), m('.helpText', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.tags-as-field-help'))]), this.tagsAsFields() ? m('.Form-group', [m('label', flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.tags-field-name')), m('input.FormControl', {
      value: this.tagsFieldName(),
      placeholder: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('raafirivero-mason.admin.settings.tags-field-name-placeholder'),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TagFields; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/helpers/icon */ "flarum/helpers/icon");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(TagFields, _Component);
  ...
  _proto.initRows = function initRows(result) {
    var _this2 = this;
    ...
    var fields = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.all('raafirivero-mason-field'); // convert to strings for API call

    var tagname = this.tag;
    var thetagID = this.tagID; // match each Tag with the rows in the database that contain its fields

    this.matchingTag = tempStorage.filter(function (match) {
    ...
    if (this.matchingTag == false) {
      var i = 0;
      Object(_lib_helpers_sortByAttribute__WEBPACK_IMPORTED_MODULE_5__["default"])(fields).forEach(function (field) {
        var rec = flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.createRecord('raafirivero-mason-bytag', {
          attributes: {
            tag_name: tagname,
            tag_id: thetagID,
            allowed_field: JSON.stringify(field.data.attributes.name),
  ...
  _proto.buildSwitches = function buildSwitches() {
    ...
    this.matchingTag.forEach(function (field) {
      ...
      var rowID = field.data.id;

      _this3.fieldsList.push(m('.Form-group', [m('label', flarum_components_Switch__WEBPACK_IMPORTED_MODULE_4___default.a.component({
        state: mySwitch,
        onchange: _this3.updateRow.bind(_this3, rowID),
  ...
  _proto.updateRow = function updateRow(rownumber, switchstate, switchobj) {
    // switching the HTML element *before* the API call for apparent speed
    switchobj.props.state = switchstate;
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.request({
      method: 'PATCH',
      url: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('apiUrl') + '/raafirivero/mason/bytag/' + rownumber,
      data: {
        data: {
          attributes: {
            "switch": switchstate
      ...
      flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.pushPayload(result); // better to update HTML element here, but slower for the user
    });
  };

  _proto.reInit = function reInit(num) {
    // re-initialize once all the rows are made per tag;
    if (flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.all('raafirivero-mason-field').length == num) {
      this.init();
    }
  };
  ...
  _proto.view = function view() {
    ...
    return m('.Mason-Tags-Dropdown', [m('.Button.Button--block.Mason-Box-Header', {
      onclick: function onclick() {
        _this5.toggleFields = !_this5.toggleFields;
      }
...
/* harmony import */ var _lib_models_ByTag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../lib/models/ByTag */ "./src/lib/models/ByTag.js");
/* harmony import */ var _addMasonFieldsPane__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addMasonFieldsPane */ "./src/admin/addMasonFieldsPane.js");
/* harmony import */ var _addPermissions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./addPermissions */ "./src/admin/addPermissions.js");
...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('raafirivero-mason', function (app) {
  app.store.models['raafirivero-mason-field'] = _lib_models_Field__WEBPACK_IMPORTED_MODULE_2__["default"];
  app.store.models['raafirivero-mason-answer'] = _lib_models_Answer__WEBPACK_IMPORTED_MODULE_1__["default"];
  app.store.models['raafirivero-mason-bytag'] = _lib_models_ByTag__WEBPACK_IMPORTED_MODULE_3__["default"];
  Object(_addMasonFieldsPane__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_addPermissions__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
...
function (_Component) {
  ...
  _proto.init = function init() {
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.request({
      method: 'GET',
      url: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('apiUrl') + '/raafirivero/mason/fields'
    }).then(function (result) {
      flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.store.pushPayload(result);
      m.redraw();
    }); // app.request({
  ...
  _proto.updateSort = function updateSort(sorting) {
    flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.request({
      method: 'POST',
      url: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.forum.attribute('apiUrl') + '/raafirivero/mason/fields/order',
      data: {
        sort: sorting
      }
    }).then(function (result) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ByTag; });
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/app */ "flarum/app");
/* harmony import */ var flarum_app__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flarum_app__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var flarum_Model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! flarum/Model */ "flarum/Model");
...
/*#__PURE__*/
function (_mixin) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(ByTag, _mixin);
