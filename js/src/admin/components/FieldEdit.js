...
export default class FieldEdit extends Component {
    ...
    initNewField() {
        this.field = app.store.createRecord('raafirivero-mason-field', {
            attributes: {
                name: '',
                description: '',
                min_answers_count: 0,
    ...
    boxTitle() {
        ...
        return app.translator.trans('raafirivero-mason.admin.buttons.new-field');
    }
    ...
    view() {
        return m('.Mason-Box', [
            ...
            m('.Button.Button--block.Mason-Box-Header', {
                ...
                m('div', [
                    (this.field.exists ? [
                        app.translator.trans('raafirivero-mason.admin.buttons.edit-field'),
                        ' ',
                    ] : null),
        ...
        return m('form', [
            m('.Mason-Box--row', [
                m('.Mason-Box--column', [
                    m('h4', 'Field settings'),
                    m('.Form-group', [
                        m('label', app.translator.trans('raafirivero-mason.admin.fields.name')),
                        m('input.FormControl', {
                            value: this.field.name(),
                            oninput: m.withAttr('value', this.updateAttribute.bind(this, 'name')),
                        }),
                        m('.helpText', app.translator.trans('raafirivero-mason.admin.fields.name-help')),
                    ]),
                    m('.Form-group', [
                        m('label', app.translator.trans('raafirivero-mason.admin.fields.description')),
                        m('input.FormControl', {
                            value: this.field.description(),
                            oninput: m.withAttr('value', this.updateAttribute.bind(this, 'description')),
                        }),
                        m('.helpText', app.translator.trans('raafirivero-mason.admin.fields.description-help')),
                    ]),
                    m('.Form-group', [
                        m('label', [
                            ...
                            Switch.component({
                                ...
                                children: app.translator.trans('raafirivero-mason.admin.fields.required'),
                            }),
                        ]),
                    ]),
                    /*m('.Form-group', [
                    ...
                    m('.Form-group', [
                        m('label', [
                            Switch.component({
                                ...
                                children: app.translator.trans('raafirivero-mason.admin.fields.show_when_empty'),
                            }),
                        ]),
                        m('.helpText', app.translator.trans('raafirivero-mason.admin.fields.show_when_empty-help')),
                    ]),
                    m('.Form-group', [
                        m('label', [
                            Switch.component({
                                ...
                                children: app.translator.trans('raafirivero-mason.admin.fields.user_values_allowed'),
                            }),
                        ]),
                        m('.helpText', app.translator.trans('raafirivero-mason.admin.fields.user_values_allowed-help')),
                    ]),
                    m('.Form-group', [
                        m('label', app.translator.trans('raafirivero-mason.admin.fields.validation')),
                        m('input.FormControl', {
                            disabled: !this.field.user_values_allowed(),
                            placeholder: this.field.user_values_allowed() ? '' : app.translator.trans('raafirivero-mason.admin.fields.enable-user-values-for-validation'),
                            value: this.field.validation(),
                            oninput: m.withAttr('value', this.updateAttribute.bind(this, 'validation')),
                        }),
                        m('.helpText', app.translator.trans('raafirivero-mason.admin.fields.validation-help', {
                            a: m('a[href=https://laravel.com/docs/5.1/validation#available-validation-rules][_target=blank]'),
                        })),
                    ]),
                    m('.Form-group', [
                        m('label', [
                            app.translator.trans('raafirivero-mason.admin.fields.icon'),
                        ...
                        m('.helpText', app.translator.trans('raafirivero-mason.admin.fields.icon-help', {
            ...
            m('li.ButtonGroup', [
                Button.component({
                    ...
                    children: app.translator.trans('raafirivero-mason.admin.buttons.' + (this.field.exists ? 'save' : 'add') + '-field'),
                ...
                (this.field.exists ? Button.component({
                    ...
                    children: app.translator.trans('raafirivero-mason.admin.buttons.delete-field'),
                    loading: this.processing,
    ...
    deleteField() {
        if (!confirm(app.translator.trans('raafirivero-mason.admin.messages.delete-field-confirmation', {
    ...
    iconPreview(value) {
        ...
        return [
            ' (',
            app.translator.trans('raafirivero-mason.admin.fields.icon-preview', {
                preview: icon(value),
            }),
            ')',
        ];
